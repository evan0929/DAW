...
import com.popper.daw.app.MyApp;
...
//        return response;
    ...
    public static boolean isValidNetWork() {
        ConnectivityManager nw = (ConnectivityManager) MyApp.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
